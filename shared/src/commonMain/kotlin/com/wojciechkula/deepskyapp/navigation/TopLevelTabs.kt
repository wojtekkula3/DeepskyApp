...
internal enum class TopLevelTab(val key: NavKey, val label: String) {
    PictureOfTheDay(key = PictureOfTheDayKey, label = "Picture of The Day"),
    Favourites(key = FavouritesKey, label = "My favourite")
}
