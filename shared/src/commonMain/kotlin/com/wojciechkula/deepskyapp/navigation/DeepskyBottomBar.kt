        ...
        TopLevelTab.entries.forEach { tab ->
            ...
            NavigationBarItem(
                ...
                colors = NavigationBarItemDefaults.colors(
                    ...
                    unselectedIconColor = ApodTheme.colors.onSurfaceVariant,
                    unselectedTextColor = ApodTheme.colors.onSurfaceVariant
                )
            )
        }
    }
...
// favourite), which the design system now names: `favorite` is that red, per palette.
@Composable
private fun TopLevelTab.selectedColor(): Color = when (this) {
    TopLevelTab.PictureOfTheDay -> ApodTheme.colors.primary
    TopLevelTab.Favourites -> ApodTheme.colors.favorite
}
